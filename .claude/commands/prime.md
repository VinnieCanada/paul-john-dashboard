...
5. **Data status** — Review key-metrics.md freshness. Flag anything stale (>2 days old). Note you can run live SQL queries against `data/data.db` (load `reference/data-access.md` for schemas and examples when needed).
