...
Classifies meetings by stream based on participant emails matched against
the staff registry. With no registry populated, everything goes to 'general'.
"""
...
if __name__ == "__main__":
    ...
    conn = get_connection()
    n = classify_all(conn, reclassify=args.reclassify)
    print(f"Classified {n} meetings.")
    conn.close()
